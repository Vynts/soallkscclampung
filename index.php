...
echo"<script>document.location.href='homesesuatu.php?page=sesuatuhome&data=sesuatuhome';</script>";
}
?>
<!DOCTYPE html>
<html>
...
<body class="theme-blue">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?page=home&data=home"><b>RentalSesuatu.com</b></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php if ($_SESSION['level'] == 'admin') { ?>
                        ...
                        <!----------------------------------------------- TRANSAKSI MOBIL --------------------------------------->
                        <li <?php if($_GET['data']=='transaksisesuatu'){ echo "class=active"; } ?>>
                            <a href="?page=transaksisesuatu&data=transaksisesuatu">
                                <span>TRANSAKSI</span>
                            </a>
                        </li>
                        <!----------------------------------------------- TRANSAKSI MOBIL --------------------------------------->
                        ...
                        <!----------------------------------------------- MOBIL ----------------------------------------------->
                        <li <?php if($_GET['data']=='sesuatu'){ echo "class=active"; } ?>>
                            <a href="?page=sesuatu&data=sesuatu">
                                <span>MOBIL</span>
                            </a>
                        </li>
                        <!----------------------------------------------- MOBIL ----------------------------------------------->
                        ...
                        <!----------------------------------------------- LACAK ----------------------------------------------->
                        <li <?php if($_GET['data']=='lacaksesuatu'){ echo "class=active"; } ?>>
                            <a href="?page=lacaksesuatu&data=lacaksesuatu">
                    ...
                    <?php if ($_SESSION['level'] == 'customer') { ?>
                        <!----------------------------------------------- BERANDA ----------------------------------------------->
                        <li <?php if($_GET['data']=='homesesuatu'){ echo "class=active"; } ?>>
                            <a href="?page=homesesuatu&data=homesesuatu">
                                <span>BERANDA</span>
                            </a>
                        </li>
                        <!----------------------------------------------- BERANDA ----------------------------------------------->
            ...
            <div class="legal">
                <div class="copyright">
                    Copyright &copy; <a href="javascript:void(0);">RentalSesuatu.com</a>
                </div>
                <div class="version">
    ...
    if (isset($_GET['page'])) {
        ...
        switch ($page){
            ...
            case 'transaksisesuatu':
                include "content/transaksisesuatu.php";
                break;
            ...
            case 'sesuatu':
                include "content/sesuatu.php";
                break;
                             
            case 'lacaksesuatu':
                include "content/lacaksesuatu.php";
                break;
            ...
            case 'homesesuatu':
                include "content/homesesuatu.php";
                break;
